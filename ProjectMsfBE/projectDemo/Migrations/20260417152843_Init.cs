        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserUpgradeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, new DateTime(2026, 4, 17, 15, 28, 43, 471, DateTimeKind.Utc).AddTicks(1417), false, "ADMIN", null, null },
                    { 2, null, new DateTime(2026, 4, 17, 15, 28, 43, 471, DateTimeKind.Utc).AddTicks(1425), false, "ORGANIZER", null, null },
                    { 3, null, new DateTime(2026, 4, 17, 15, 28, 43, 471, DateTimeKind.Utc).AddTicks(1427), false, "CUSTOMER", null, null }
                });

            migrationBuilder.InsertData(
                table: "User",
                columns: new[] { "Id", "AvatarUrl", "CreatedBy", "CreatedDate", "DateLock", "Email", "FirstName", "IsActive", "IsDeleted", "IsLock", "Isfalse", "LastName", "PasswordHash", "UpdatedBy", "UpdatedDate", "Username" },
                values: new object[] { new Guid("11111111-1111-1111-1111-111111111111"), null, null, null, null, "admin@system.com", "admin", true, false, false, null, "admin", "$2a$11$vHQM9bIdFATqnoWYrrFWYORR.3SYoJ4gVn60xkszD8q7DMvxV655y", null, null, "admin" });
