...
namespace projectDemo.Migrations
{
    ...
    public partial class InitDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table
                        .Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TicketCode = table.Column<string>(
                        type: "nvarchar(100)",
                        maxLength: 100,
                        nullable: false
                    ),
                    QRCode = table.Column<string>(
                        type: "nvarchar(255)",
                        maxLength: 255,
                        nullable: false
                    ),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[]
                {
                    ...
                    null,
                    "system",
                    new DateTime(2026, 2, 27, 8, 27, 32, 705, DateTimeKind.Utc).AddTicks(1432),
                    "admin@system.com",
                    "admin",
                    true,
                    false,
                    ...
                    "admin",
                    "system",
                    new DateTime(2026, 2, 27, 8, 27, 32, 705, DateTimeKind.Utc).AddTicks(1437),
                    "admin",
                }
            );
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[]
                {
                    1,
                    "system",
                    new DateTime(2026, 2, 27, 8, 27, 32, 705, DateTimeKind.Utc).AddTicks(1458),
                    false,
                    "$2a$11$Wyj.FXEpmA0G3BQZhG.AsulGe.xRPc4NLc88ucafTeoctgqwD0v5W",
                    null,
                    null,
                    "system",
                    new DateTime(2026, 2, 27, 8, 27, 32, 705, DateTimeKind.Utc).AddTicks(1459),
                    new Guid("11111111-1111-1111-1111-111111111111"),
                }
            );
            ...
            migrationBuilder.CreateIndex(name: "IX_Event_UserID", table: "Event", column: "UserID");
        ...
        {
            migrationBuilder.DropTable(name: "ApiLog");
            ...
            migrationBuilder.DropTable(name: "TicketType");
