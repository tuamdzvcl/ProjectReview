        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PermissonsName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PermissonsDescription = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AmountLimit = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Isfalse = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserPromotion_Promotions_PromotionId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 4, null, null, false, "xem tất cả user sự dụng hệ thống", "USER_VIEW_ALL", null, null },
                    ...
                    { 12, null, null, false, " xem chi tiết thông tin event", "EVENT_VIEW_DETIAL", null, null },
                    { 13, null, null, false, "xem vé thành viên", "VIEW_UPGRADE", null, null },
                    { 14, null, null, false, "tạo vé thành viên", "CREATE_UPGRADE", null, null },
                    { 15, null, null, false, "xem báo cáo doanh thu", "VEIW_DASHBOARD", null, null },
                    { 16, null, null, false, "xem báo cáo doanh thu của hệ thống", "VIEW_DASHBOARHALL", null, null },
                    { 17, null, null, false, "xem khuyễn mãi", "VIEW_KM", null, null },
                    { 18, null, null, false, " xem log của hệ thống", "VIEW_AUDILOG", null, null },
                    { 19, null, null, false, "xóa vé thành viên", "UPGRADE_DELETE", null, null },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, new DateTime(2026, 5, 16, 0, 57, 16, 239, DateTimeKind.Utc).AddTicks(7705), true, false, true, "ADMIN", null, null },
                    { 2, null, new DateTime(2026, 5, 16, 0, 57, 16, 239, DateTimeKind.Utc).AddTicks(7714), false, false, true, "ORGANIZER", null, null },
                    { 3, null, new DateTime(2026, 5, 16, 0, 57, 16, 239, DateTimeKind.Utc).AddTicks(7717), false, false, true, "CUSTOMER", null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("11111111-1111-1111-1111-111111111111"), null, null, null, null, null, "admin@system.com", "admin", true, true, false, false, null, "admin", "$2a$11$PVCeAJJwTcxPytqsAU7XfuFFeXvI4a9Fz5ZOPX1Uic.8Gldfo4ukq", null, null, "admin" });
